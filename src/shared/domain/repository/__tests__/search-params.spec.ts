...
describe("SearchParams Unit Tests", () => {
  describe("page prop", () => {
    ...
    test.each(arrange)("page = %j", ({ page, expected }) => {
  ...
  describe("per_page prop", () => {
    ...
    test.each(arrange)("per_page = %j", ({ per_page, expected }) => {
  ...
  describe("sort prop", () => {
    ...
    test.each(arrange)("sort = %j", ({ sort, expected }) => {
  ...
  describe("sort_dir prop", () => {
    ...
    test.each(arrange)("sort_dir = %j", ({ sort_dir, expected }) => {
      expect(
  ...
  describe("filter prop", () => {
    ...
    test.each(arrange)("filter = %j", ({ filter, expected }) => {
